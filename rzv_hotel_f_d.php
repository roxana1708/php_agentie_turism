<?php 
    ...
    if(isset($_SESSION['err_msg'])) {
        ...
        $nr_stele_err = $_SESSION['err_msg']['nr_stele_err'];
...
<body>
    ...
    <form action="rzv_h_f_d_action_form.php" method="post">
        <div>
        ...
        <div>
            <label>Alege numarul de oaspeti:</label>
            <input type="number" name="nr_pers" min="1" max="40">
            <span style="color:red"><?php echo $nr_pers_err ?></span>
        </div>

        <div>
            <label>Alege numarul de stele al hotelului:</label>
            <select name="nr_stele">
                <option value="3">3</option>
                <option value="5">5</option>
            </select>
            
            <span style="color:red"><?php echo $nr_stele_err ?></span>
        </div>
